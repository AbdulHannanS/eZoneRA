...
$(window).scroll(function(brtag)
	{
		...
		if(document.getElementsByClassName("org-about-company-module__company-page-url truncate Sans-15px-black-70% mb3")[0].childElementCount>=3)
	      	{
	      			 
		}
		else
		{
		document.getElementsByClassName("org-about-us-company-module__website mb3 link-without-visited-state ember-view")[0].parentNode.appendChild(document.createElement("br"));
		document.getElementsByClassName("org-about-us-company-module__website mb3 link-without-visited-state ember-view")[0].parentNode.appendChild(inputCreator(document.getElementsByClassName("org-about-us-company-module__website mb3 link-without-visited-state ember-view")[0].innerText));
